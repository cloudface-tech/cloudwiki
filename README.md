...
<img src="ux/public/_assets/logo-cloudwiki-full.svg" alt="CloudWiki" width="280" />
...
services:
  ...
  cloudwiki:
    image: ghcr.io/gmowses/cloudwiki:latest
    depends_on:
      - db
    ports:
      - "3000:3000"
...
2. **Create a branch** from `vega`: `git checkout -b feat/my-feature vega`
3. **Make your changes** with clear, atomic commits
4. **Test** your changes: `cd ux && pnpm build`
5. **Open a Pull Request** against the `vega` branch
...
- All containers must define `resources` (requests/limits) in Helm values
