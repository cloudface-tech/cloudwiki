...
<img src="https://static.gmowses.io/logo/cloudwiki-full.svg" alt="CloudWiki" width="600" />

[![Release](https://img.shields.io/github/release/Requarks/wiki.svg?style=flat&maxAge=3600)](https://github.com/Requarks/wiki/releases)
[![License](https://img.shields.io/badge/license-AGPLv3-blue.svg?style=flat)](https://github.com/gmowses/cloudwiki/blob/master/LICENSE)
...
[![Docker Pulls](https://img.shields.io/docker/pulls/gmowses/cloudwiki.svg?logo=docker&logoColor=white)](https://hub.docker.com/r/gmowses/cloudwiki/)  
...
[![Open Collective backers and sponsors](https://img.shields.io/opencollective/all/cloudwiki?label=backers&color=218bff&logo=opencollective&logoColor=white)](https://opencollective.com/cloudwiki)  
[![Chat on Slack](https://img.shields.io/badge/slack-gmowses-CC2B5E.svg?style=flat&logo=slack)](https://wiki.gmowses.io/slack)
[![Twitter Follow](https://img.shields.io/badge/follow-%40gmowses-blue.svg?style=flat&logo=twitter)](https://twitter.com/gmowses)
[![Reddit](https://img.shields.io/badge/reddit-%2Fr%2Fcloudwiki-orange?logo=reddit&logoColor=white)](https://www.reddit.com/r/cloudwiki/)
[![Subscribe to Newsletter](https://img.shields.io/badge/newsletter-subscribe-yellow.svg?style=flat&logo=mailchimp)](https://blog.wiki.cloudface.tech/subscribe)
...
- **[Documentation](https://docs.gmowses.io/)**

<h2 align="center">Donate</h2>

<div align="center">

CloudWiki is an open source project that has been made possible due to the generous contributions by community [backers](https://wiki.js.org/about). If you are interested in supporting this project, please consider [becoming a sponsor](https://github.com/users/NGPixel/sponsorship), [becoming a patron](https://www.patreon.com/gmowses), donating to our [OpenCollective](https://opencollective.com/cloudwiki), via [Paypal](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=FLV5X255Z9CJU&source=url) or via Ethereum (`0xe1d55c19ae86f6bcbfb17e7f06ace96bdbb22cb5`).
...
## Adding the CloudWiki Helm Repository

```console
$ helm repo add gmowses https://charts.wiki.cloudface.tech
```
...
### Using Helm 3:
```console
$ helm install my-release gmowses/cloudwiki
```
### Using Helm 2:
```console
$ helm install --name my-release gmowses/cloudwiki
```

The command deploys CloudWiki on the Kubernetes cluster in the default configuration. The [configuration](#configuration) section lists the parameters that can be configured during installation.
...
The following table lists the configurable parameters of the CloudWiki chart and their default values.

| Parameter                            | Description                                 | Default                                                    |
| -------------------------------      | -------------------------------             | ---------------------------------------------------------- |
| `image.repository`                   | CloudWiki image                                | `gmowses/cloudwiki`                                           |
| `image.tag`                          | CloudWiki image tag                            | `latest`                                                      |
...
| `volumeMounts`                   | Volume mounts for CloudWiki container              | `[]`                                                       |
| `volumes`                        | Volumes for CloudWiki Pod                          | `[]`                                                       |
...
```console
$ helm install --name my-release -f values.yaml gmowses/cloudwiki
```
